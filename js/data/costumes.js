 ...
 *
 * Generated by tools/build-fighters.py from what is actually on disk, so a
 * costume cannot claim finished art it does not have. A costume missing from
 * this list renders with the fighter's base body and reports itself as a
 * fallback — that path still exists, it just has no occupants right now.
 */
export const COSTUMES_WITH_ART = Object.freeze([
  "naruto:kid", "naruto:shippuden", "naruto:the_last", "naruto:hokage",
  "naruto:adult", "sasuke:kid", "sasuke:shippuden", "sasuke:the_last",
  "sasuke:adult", "sakura:genin", "sakura:shippuden", "sakura:adult",
  "kakashi:young", "kakashi:anbu", "kakashi:jonin", "kakashi:hokage",
  "sai:shippuden", "sai:adult", "shikamaru:shippuden", "shikamaru:adult",
  "choji:shippuden", "choji:adult", "ino:shippuden", "ino:adult",
  "hinata:genin", "hinata:shippuden", "hinata:adult", "kiba:shippuden",
  "kiba:adult", "shino:shippuden", "shino:adult", "lee:genin", "lee:adult",
  "tenten:shippuden", "tenten:adult", "guy:young", "guy:jonin",
  "konohamaru:genin", "konohamaru:adult", "hanabi:genin", "hanabi:adult",
  "hashirama:young", "hashirama:hokage", "tobirama:young", "tobirama:hokage",
  "hiruzen:young", "hiruzen:elder", "minato:young", "minato:hokage",
  "tsunade:young", "tsunade:hokage", "jiraiya:young", "jiraiya:sannin",
  "orochimaru:young", "orochimaru:sannin", "gaara:genin", "gaara:kazekage",
  "gaara:adult", "temari:shippuden", "temari:adult", "kankuro:shippuden",
  "kankuro:adult", "obito:young", "obito:tobi", "obito:masked",
  "obito:white_mask", "obito:war", "white_zetsu:base", "madara:young",
  "madara:valley", "madara:war", "madara:edo", "boruto:genin",
  "boruto:timeskip", "momoshiki:base",
]);
 ...
 *
 * The Default Outfit is the one permanent `fallback`: it *is* the base body,
 * so "falls back to the base fighter art" is the correct description of it
 * rather than a gap in the artwork.
 */
